...
namespace :mostfit do
  namespace :mock do
    ...
    task :load_demo do
      # Rake::Task['mostfit:mock:fixtures'].invoke
      # Rake::Task['mostfit:mock:all_payments'].invoke
      # Rake::Task['mostfit:mock:update_history'].invoke
      puts
    ...
    task :fixtures do
      ...
      load_fixtures :users, :staff_members, :funders, :funding_lines, :branches, :centers, :clients, :credit_account_rule,:rule_book,:loan_products, :loans  #, :payments
      puts
